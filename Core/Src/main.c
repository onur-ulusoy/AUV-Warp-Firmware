...
int main(void)
{
  ...
  /* Enable Converters */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_SET); // PC.13 is the Converter 1 Switch
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_SET); // PB.2 is the Converter 2 Switch

  /* Make the buzzer sound for a short period */
